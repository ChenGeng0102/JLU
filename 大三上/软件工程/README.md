...
2. **画用例图和类图**
    ...
    - 纯英文的题面（类似于英语阅读，一大段文本），大致内容应该是：有一个诊所，涉及到医生、护士、前台、病人这么几个角色，然后每个角色都有对应的动作，比如病人需要定期来检查等等。


### **备考策略**：
- 这门课考试的时候除了最后一题，前面做的飞快，因为基本都准备到了。但选择、判断和名词解释考的还是特别细致的，如果之前没做过的话可能还是有点难度。
